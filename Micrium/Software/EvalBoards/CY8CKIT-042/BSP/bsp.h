...
* Programmer(s) : DC
*
* V1.20		Modified by YFS (Cypress) to simplify BSP. Removed unused LED and push button APIs.
...
/* YFS note for Cypress PSoC.
- For Cortex M3 devices (PSoC 5) use BCLK__BUS_CLK__HZ
- For Cortex-M0 devices (PSoC 4) use CYDEV_BCLK__SYSCLK__HZ
*/
